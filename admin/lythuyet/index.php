        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="text-right">
                    <a href="<?php echo $base_url; ?>admin/lythuyet/create.php" class="btn btn-success">Add new row</a>
                </div>
                <br><br>
            </div>
            ...
            <?php
                ...
                $aLythuyet = $oLythuyet->getAll();
                $n = $oLythuyet->getNumRows();
            ?>
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <?php if($aLythuyet && count($aLythuyet) > 0){ ?>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        ...
                                        <th width="20%">Hình thumbnail</th>
                                        <th width="40%">Tóm tắt</th>
                                        <th>&nbsp;</th>
                                        <th>&nbsp;</th>
                                    </tr>
                                    <?php while($row = $aLythuyet->fetch_assoc()){ ?>
                                        <tr>
                                            <td><?php echo $row['id']; ?></td>
                                            <td><?php echo $row['title']; ?></td>
                                            <td><img src="<?php echo $base_url; ?>resource/images/<?php if(strlen($row['img_thumbnail'])>0){ echo $row['img_thumbnail'];}else{ echo 'no-image.png'; } ?>" style="height:80px;width:100%;" /> </td>
                                            <td><p><?php echo $row['summary']; ?></p></td>
                                            <td><a href="<?php echo $base_url; ?>admin/lythuyet/update.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Edit</a> </td>
                                            <td><a href="<?php echo $base_url; ?>admin/lythuyet/process.php?id=<?php echo $row['id']; ?>&processname=delete" onclick="if(!confirm('Are you sure to delete?')){ event.preventDefault(); };" class="btn btn-success btn_delete">Delete</a> </td>
                                        </tr>
                                    <?php } ?>
                                </table>
