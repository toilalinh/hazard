        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <?php
                    ...
                    $update_lythuyet = $result->fetch_assoc();
                ?>
                <form action="process.php" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="title" value="<?php echo $update_lythuyet['title']; ?>" /> </td>
                        </tr>
                        <tr>
                            <td>Hình thumbnail</td>
                            <td>
                                <img src="../../resource/images/<?php if(strlen($update_lythuyet['img_thumbnail'])>0){ echo $update_lythuyet['img_thumbnail'];}else{ echo 'no-image.png'; } ?>" style="height:100px;width:150px;" />
                                <br><br>
                        ...
                        <tr>
                            <td>Tóm tắt</td>
                            <td>
                                <textarea rows="5" name="summary" class="form-control"><?php echo $update_lythuyet['summary']; ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>Nội dung</td>
                            <td>
                                        <textarea rows="10" name="content" id="summernote" class="form-control">
                                            <?php echo $update_lythuyet['content']; ?>
                                        </textarea>
                            </td>
                        </tr>
                        <tr>
