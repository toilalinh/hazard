...
$result = $oCasestudy->getById($id);
$row_casestudy = $result->fetch_assoc();
$result = $oCasestudy->getRelated($id);
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div id="header">
        ...
        <div id="navigation">
            <ul>
                ...
                <li><a href="<?php echo $base_url; ?>frontend/casestudy.php?p=1" class="selected">CASE STUDY</a> </li>
    ...
    <div class="wrapper-middle">
        ...
        <div class="lythuyet-detail">
            ...
            <div class="bv-lythuyet">
                <h3 style="text-transform: uppercase;"><?php echo $row_casestudy['title']; ?></h3>
                <p><img src="../resource/views/images/calendar-icon.png" />&nbsp;&nbsp;<?php echo $row_casestudy['date_change']; ?> </p>
                <div>
                    <iframe width="100%" height="500px" frameborder="0"
                            src="<?php echo getVideoEmbed($row_casestudy['video_url']); ?>">
                    </iframe>
                </div>
                <div>
                  <?php echo $row_casestudy['content']; ?>
                </div>
            </div>
            <hr>
            ...
            <div class="related-lythuyet">
                ...
                <div class="lst">
                    <?php while($row = $result->fetch_assoc()){ ?>
                        <div>
                            <img src="<?php if(empty($row['video_url'])){ echo '../resource/images/no-image.png'; }else{ echo getThumbnailFromYoutubeLink($row['video_url']); } ?>" />
                            <p class="title-post">
                                <a style="color:#7a7979;" href="<?php echo $base_url; ?>frontend/casestudy_detail.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a>
                            </p>
